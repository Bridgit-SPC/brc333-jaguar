...
def main():
    # Get a dictionary of color names and counts from the image
    image_path = './traits/redpyramid.png'  # Replace with your image file path
    color_names = get_image_colors(image_path)

    # Create an HTML file to display the colors
    html_file_path = 'colors_in_image3.html'
    ...
    for selected_color in selected_colors:
        ...
        output_file_name = 'output_color_coordinates.txt'
